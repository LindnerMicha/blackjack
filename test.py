    ...
    if maus_pos[0] > but_x and maus_pos[0] < but_x + but_laenge and maus_pos[1] > but_y and maus_pos[1] < but_y+but_hoehe:
        ...
        if maus_klick[0] == 1 and maus_aktiv == False:
            ...
            if but_txt == "Hit":
                ...
                cards_temp.remove(cards_temp[r_int])
...
def card(but_txt, but_x, but_y, but_laenge, but_hoehe, but_color_0, but_color_1, but_font):
    ...
    textkasten.center = ((but_x+(but_laenge/2)),(but_y+(but_hoehe/2)))
    screen.blit(textGrund, textkasten)
    screen.blit(icon_herz, (but_x+10, but_y+65))
...
icon_herz = pygame.image.load("icon/herz.png")
icon_baum = pygame.image.load("icon/baum.png")
icon_dia = pygame.image.load("icon/dia.png")
icon_hrzblt = pygame.image.load("icon/hrzblt.png")

cards = [
    ["II", 2, (255, 100, 100), (255, 200, 200), "Herz"],
    ["III", 3, (255, 100, 100), (255, 200, 200), "Herz"],
    ["IV", 4, (255, 100, 100), (255, 200, 200), "Herz"],
    ["V", 5, (255, 100, 100), (255, 200, 200), "Herz"],
    ["VI", 6, (255, 100, 100), (255, 200, 200), "Herz"],
    ["VII", 7, (255, 100, 100), (255, 200, 200), "Herz"],
    ["VIII", 8, (255, 100, 100), (255, 200, 200), "Herz"],
    ["IX", 9, (255, 100, 100), (255, 200, 200), "Herz"],
    ["X", 10, (255, 100, 100), (255, 200, 200), "Herz"],
    ["K", 10, (255, 100, 100), (255, 200, 200), "Herz"],
    ["A", 10, (255, 100, 100), (255, 200, 200), "Herz"],


    ["II", 2, (255, 100, 100), (255, 200, 200), "baum"],
    ["III", 3, (255, 100, 100), (255, 200, 200), "baum"],
    ["IV", 4, (255, 100, 100), (255, 200, 200), "baum"],
    ["V", 5, (255, 100, 100), (255, 200, 200), "baum"],
    ["VI", 6, (255, 100, 100), (255, 200, 200), "baum"],
    ["VII", 7, (255, 100, 100), (255, 200, 200), "baum"],
    ["VIII", 8, (255, 100, 100), (255, 200, 200), "baum"],
    ["IX", 9, (255, 100, 100), (255, 200, 200), "baum"],
    ["X", 10, (255, 100, 100), (255, 200, 200), "baum"],
    ["K", 10, (255, 100, 100), (255, 200, 200), "baum"],
    ["A", 10, (255, 100, 100), (255, 200, 200), "baum"],


    ["II", 2, (255, 100, 100), (255, 200, 200), "dia"],
    ["III", 3, (255, 100, 100), (255, 200, 200), "dia"],
    ["IV", 4, (255, 100, 100), (255, 200, 200), "dia"],
    ["V", 5, (255, 100, 100), (255, 200, 200), "dia"],
    ["VI", 6, (255, 100, 100), (255, 200, 200), "dia"],
    ["VII", 7, (255, 100, 100), (255, 200, 200), "dia"],
    ["VIII", 8, (255, 100, 100), (255, 200, 200), "dia"],
    ["IX", 9, (255, 100, 100), (255, 200, 200), "dia"],
    ["X", 10, (255, 100, 100), (255, 200, 200), "dia"],
    ["K", 10, (255, 100, 100), (255, 200, 200), "dia"],
    ["A", 10, (255, 100, 100), (255, 200, 200), "dia"],


    ["II", 2, (255, 100, 100), (255, 200, 200), "hrzblt"],
    ["III", 3, (255, 100, 100), (255, 200, 200), "hrzblt"],
    ["IV", 4, (255, 100, 100), (255, 200, 200), "hrzblt"],
    ["V", 5, (255, 100, 100), (255, 200, 200), "hrzblt"],
    ["VI", 6, (255, 100, 100), (255, 200, 200), "hrzblt"],
    ["VII", 7, (255, 100, 100), (255, 200, 200), "hrzblt"],
    ["VIII", 8, (255, 100, 100), (255, 200, 200), "hrzblt"],
    ["IX", 9, (255, 100, 100), (255, 200, 200), "hrzblt"],
    ["X", 10, (255, 100, 100), (255, 200, 200), "hrzblt"],
    ["K", 10, (255, 100, 100), (255, 200, 200), "hrzblt"],
    ["A", 10, (255, 100, 100), (255, 200, 200), "hrzblt"],
]

cards_temp = cards.copy()
